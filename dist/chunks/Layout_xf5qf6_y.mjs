  ...
  if (isMobile) {
    if (isSSR) {
      return /* @__PURE__ */ jsxs(
        "a",
        {
          ...
          children: [
            /* @__PURE__ */ jsx("span", { className: "text-xs font-bold", children: lang === "en" ? "தமிழ்" : "ENG" }),
            /* @__PURE__ */ jsx("i", { className: "fa-solid fa-language text-red-500 text-sm", "aria-hidden": "true" })
          ]
        }
      );
    }
    return /* @__PURE__ */ jsxs(
      "button",
      {
        ...
        "aria-label": `Switch to ${lang === "en" ? "Tamil" : "English"}`,
        children: [
          /* @__PURE__ */ jsx("span", { className: `text-xs font-bold ${lang === "ta" ? "" : "hidden"}`, children: "தமிழ்" }),
          /* @__PURE__ */ jsx("span", { className: `text-xs font-bold ${lang === "en" ? "" : "hidden"}`, children: "ENG" }),
          /* @__PURE__ */ jsx("i", { className: "fa-solid fa-language text-red-500 text-sm", "aria-hidden": "true" })
        ]
      }
    );

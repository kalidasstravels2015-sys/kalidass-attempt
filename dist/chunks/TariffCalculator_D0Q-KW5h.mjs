import { c as createComponent, m as maybeRenderHead, b as addAttribute, r as renderComponent, a as renderTemplate } from './astro/server_B-UY_wom.mjs';
import 'kleur/colors';
import { $ as $$OptimizedImage } from './OptimizedImage_BicJadH1.mjs';
import { s as siteContent, u as useLanguage } from './Layout_xf5qf6_y.mjs';
import { Q as QuotationEngine, t as trackEvent } from './QuotationEngine_CxjmQnzi.mjs';
import { jsxs, jsx, Fragment } from 'react/jsx-runtime';
import React, { useState, useRef, useEffect } from 'react';
import { s as serviceDetails } from './serviceDetails_CAUNQnnT.mjs';
/* empty css                         */
import 'clsx';
import { ArrowRight, ShieldCheck, Clock, Languages, Star } from 'lucide-react';
...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="relative min-h-[70dvh] flex items-center justify-center overflow-hidden pb-32"> <!-- Background Slideshow --> <div class="absolute inset-0 z-0"> <div class="hero-slides absolute inset-0 pointer-events-none" aria-hidden="true"> ${heroImages.map((image, index) => renderTemplate`<div class="hero-slide relative w-full h-full"${addAttribute(`animation-delay: ${index * 6}s; opacity: 0;`, "style")}> ${renderComponent($$result, "OptimizedImage", $$OptimizedImage, { "src": image, "alt": "Hero Background", "class": "absolute inset-0 w-full h-full object-cover", "loading": index === 0 ? "eager" : "lazy" })} </div>`)} </div> <div class="absolute inset-0" style="background: linear-gradient(to bottom, rgba(0,0,0,0.2), rgba(0,0,0,0.5));"></div> </div> <div class="relative z-10 max-w-3xl mx-4 sm:mx-auto text-center space-y-6"> <div class="inline-flex items-center justify-center gap-2 px-3 py-1 rounded-full bg-black/40 border border-white/10 mb-2"> <span class="text-green-400 animate-pulse text-[10px]">●</span> <p class="text-xs font-semibold uppercase tracking-widest text-white"> <span class="lang-en">Trusted by 1,000+ Families</span> <span class="lang-ta">1,000+ குடும்பங்களின் நம்பிக்கை</span> </p> </div> <h1 class="text-3xl sm:text-5xl lg:text-6xl font-extrabold text-white leading-tight drop-shadow-xl mb-4"> <span class="lang-en block">Premium Taxi Service in Chennai</span> <span class="lang-en block text-2xl sm:text-3xl lg:text-4xl text-yellow-300 mt-2 font-bold">Temple Tours & Corporate Travel</span> <span class="lang-ta block">சென்னையில் சிறந்த டாக்ஸி சேவை</span> <span class="lang-ta block text-xl sm:text-2xl lg:text-3xl text-yellow-300 mt-2 font-bold">கோவில் சுற்றுலா & கார்ப்பரேட் பயணங்கள்</span> </h1> <p class="text-base sm:text-lg text-white/95 font-medium drop-shadow-md px-4 max-w-2xl mx-auto"> <span class="lang-en">Experience safe, reliable, and comfortable outstation cabs, pilgrims
        packages, and employee transportation with standard rates.</span> <span class="lang-ta">பாதுகாப்பான மற்றும் வசதியான வெளியூர் பயணங்கள், ஆன்மீகச் சுற்றுலா
        மற்றும் அலுவலகப் போக்குவரத்துக்கு எங்களை அணுகவும்.</span> </p> </div> <!-- Scroll Indicator --> <div class="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce"> <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3"></path> </svg> </div> </section> <style>
  .hero-slides {
    position: absolute;
    inset: 0;
    overflow: hidden;
...
const FleetCard = ({ vehicle, lang, isVisible }) => {
  return /* @__PURE__ */ jsx("div", { className: "flex-shrink-0 w-72 snap-center md:w-auto md:snap-align-none transition-opacity duration-500 opacity-100", children: /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 h-full flex flex-col", children: [
    /* @__PURE__ */ jsx("div", { className: "relative h-48 overflow-hidden bg-gray-200", children: isVisible && /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsx(
        "img",
        {
          src: vehicle.image,
      ...
      /* @__PURE__ */ jsx("div", { className: "absolute bottom-4 left-4", children: /* @__PURE__ */ jsx("h3", { className: "text-xl font-bold text-white", children: lang === "ta" ? vehicle.name_ta || vehicle.name : vehicle.name }) })
    ] }) }),
    /* @__PURE__ */ jsxs("div", { className: "p-6 flex-1 flex flex-col justify-between", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-4 pb-4 border-b border-gray-300", children: [
        /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600", children: lang === "ta" ? "கி.மீ. கட்டணம்" : "Rate per KM" }),
          /* @__PURE__ */ jsx("p", { className: "text-2xl font-bold text-blue-600", children: lang === "ta" ? vehicle.rate_ta || vehicle.rate : vehicle.rate })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
          /* @__PURE__ */ jsx("p", { className: "text-sm text-gray-600", children: lang === "ta" ? "கொள்ளளவு" : "Capacity" }),
          /* @__PURE__ */ jsx("p", { className: "text-lg font-semibold text-gray-900", children: lang === "ta" ? vehicle.caps_ta || vehicle.caps : vehicle.caps }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-gray-600", children: lang === "ta" ? vehicle.bags_ta || vehicle.bags : vehicle.bags })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "space-y-2 text-sm text-gray-700", children: vehicle.details.map((feature, idx) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
        /* @__PURE__ */ jsx("svg", { className: "w-4 h-4 text-green-500 shrink-0", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", "aria-hidden": "true", children: /* @__PURE__ */ jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "2", d: "M5 13l4 4L19 7" }) }),
        feature
      ] }, idx)) })
    ] })
  ] }) });
...
const FleetRoll = ({ currentLang }) => {
  ...
  return /* @__PURE__ */ jsxs("section", { id: "fleet", className: "py-10 md:py-16 bg-white", ref: containerRef, "aria-labelledby": "fleet-heading", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsx(
          "div",
          {
            ...
            children: fleet.slice(0, visibleCount).map((vehicle, index) => /* @__PURE__ */ jsx(FleetCard, { vehicle, lang, isVisible: true }, index))
          }
        ),
        /* @__PURE__ */ jsx("div", { className: "flex justify-center mt-6 space-x-2 md:hidden", "aria-hidden": "true", children: fleet.slice(0, visibleCount).map((_, index) => /* @__PURE__ */ jsx("div", { className: "w-2 h-2 rounded-full bg-gray-300" }, index)) })
      ] })
    ] }),
...
const DriverCard = ({ driver, lang }) => /* @__PURE__ */ jsxs("div", { className: "flex-none w-72 snap-center bg-white rounded-2xl shadow-sm border border-slate-200 p-4 hover:shadow-md transition-all duration-300 group", children: [
  /* @__PURE__ */ jsxs("div", { className: "relative mb-4 overflow-hidden rounded-xl", children: [
    ...
    /* @__PURE__ */ jsx("span", { className: "absolute bottom-2 left-2 bg-indigo-600 text-white text-[10px] font-bold px-2 py-1 rounded shadow-sm", children: lang === "ta" ? driver.tag_ta || driver.tag : driver.tag })
  ] }),
  /* @__PURE__ */ jsx("h3", { className: "font-bold text-lg text-slate-900", children: lang === "ta" ? driver.name_ta || driver.name : driver.name }),
  ...
  /* @__PURE__ */ jsxs("div", { className: "text-sm text-slate-600 mt-1 space-y-2", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      ...
      /* @__PURE__ */ jsx("span", { children: lang === "ta" ? driver.experience_ta || driver.experience : driver.experience })
    ] }),
    /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
      /* @__PURE__ */ jsx(Languages, { className: "w-4 h-4 text-slate-500", "aria-hidden": "true" }),
      /* @__PURE__ */ jsx("span", { children: lang === "ta" ? driver.languages_ta || driver.languages : driver.languages })
    ] })
  ] }),
  /* @__PURE__ */ jsxs("div", { className: "flex text-yellow-400 mt-4 gap-0.5", "aria-label": "Rated 5 out of 5 stars", role: "img", children: [
    /* @__PURE__ */ jsx(Star, { className: "w-4 h-4 fill-current", "aria-hidden": "true" }),
    /* @__PURE__ */ jsx(Star, { className: "w-4 h-4 fill-current", "aria-hidden": "true" }),
    /* @__PURE__ */ jsx(Star, { className: "w-4 h-4 fill-current", "aria-hidden": "true" }),
    /* @__PURE__ */ jsx(Star, { className: "w-4 h-4 fill-current", "aria-hidden": "true" }),
    /* @__PURE__ */ jsx(Star, { className: "w-4 h-4 fill-current", "aria-hidden": "true" })
...
const DriversCarousel = ({ currentLang }) => {
  ...
  return /* @__PURE__ */ jsxs("section", { className: "py-20 bg-slate-50", "aria-labelledby": "drivers-heading", children: [
    /* @__PURE__ */ jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      ...
      hasMore && /* @__PURE__ */ jsx("div", { className: "text-center mt-8", children: /* @__PURE__ */ jsx(
        "button",
        {
          onClick: loadMore,
          ...
          children: lang === "ta" ? "மேலும் காண்க" : "Load More"
        }
      ) }),
